...
<div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
    <section class="pt-3 pb-4" id="count-stats">
        <div class="container">
                    ...
                    <div class="col-12 mx-auto">
                        <div>
                            ...
                            <span class="text-primary">
                                {{ \Carbon\Carbon::parse($reportReplacement->report->Start_Report)->format('d-m-Y') }}
                            </span>
                        </div>
                        <div>Member Pengganti - <span class="text-primary">{{ $member->Name_Member }}</span></div>
            ...
            <!-- Tombol Back -->
            <a class="btn btn-primary mx-3" href="{{ route('replacement_member') }}">
            ...
            <div class="table-responsive p-0">
                <table id="example" class="table align-items-center mb-0">
                    ...
                    <tbody>
                        ...
                        <tr onclick="window.location='{{ route('replacement_list_member.detail', ['Id_List_Report_Replacement' => $l->Id_List_Report_Replacement]) }}'" class="row-data">
