            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 mx-auto">
                        ...
                        <div>Tractor - <a class="text-primary" href="{{ route('list_report_detail', ['Id_Report' => $Id_Report, 'Name_Tractor' => $tractor->Name_Tractor]) }}">{{ $tractor->Name_Tractor }}</a></div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-6">
                            <img src="{{ asset($tractor->Photo_Tractor ?? 'storage/tractors/default.png') }}" alt="{{ $tractor->Name_Tractor }}" 
