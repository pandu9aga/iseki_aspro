        ...
        <section class="pt-3 pb-4" id="count-stats">
            <div class="container">
                ...
                <div class="d-flex gap-2 mb-4 align-items-center">
                    <a class="btn btn-primary mb-0" href="{{ route('list_report_replacement', ['Id_Report_Replacement' => $listReport->Id_Report_Replacement]) }}">
                        <i class="material-symbols-rounded text-sm">arrow_back</i> Back
                    </a>

                    <div class="d-flex align-items-center gap-2 ms-auto">
                        @if($prevReportId)
                            <a href="{{ route('report.replacement_detail', ['Id_List_Report_Replacement' => $prevReportId]) }}" class="btn btn-outline-primary mb-0" title="Previous Report">
                        ...
                        @if($nextReportId)
                            <a href="{{ route('report.replacement_detail', ['Id_List_Report_Replacement' => $nextReportId]) }}" class="btn btn-outline-primary mb-0" title="Next Report">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
                    @if($prevReportId)
                        <a href="{{ route('report.replacement_detail', ['Id_List_Report_Replacement' => $prevReportId]) }}" class="btn btn-outline-primary">
                    ...
                    @if($nextReportId)
                        <a href="{{ route('report.replacement_detail', ['Id_List_Report_Replacement' => $nextReportId]) }}" class="btn btn-outline-primary">
