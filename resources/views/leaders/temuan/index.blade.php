            ...
            <div class="modal-content">
                ...
                <form id="tipeTemuanForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group input-group-outline is-filled mb-3" id="customTipeContainer" style="display: none;">
                            <label for="tipe_temuan_custom" class="form-label">Tipe Temuan Custom</label>
                            <input type="text" class="form-control" id="tipe_temuan_custom" name="tipe_temuan_custom" placeholder="Masukkan tipe temuan custom">
                        </div>
                    </div>
