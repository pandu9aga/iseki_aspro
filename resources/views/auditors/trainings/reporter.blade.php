            ...
            <div class="table-responsive p-0">
                <table id="example" class="table align-items-center mb-0">
                    ...
                    <tbody>
                        ...
                        <tr onclick="window.location='{{ route('list_training_auditor', ['Id_Training' => $report->Id_Training]) }}'" class="row-data">
                            <td class="align-middle text-center">
                                <p class="text-xs font-weight-bold text-secondary">{{ $loop->iteration }}</p>
                            </td>
                            <td class="align-middle text-center">
                                <p class="text-xs text-primary mb-0">{{ \Carbon\Carbon::parse($report->Start_Training)->format('d-m-Y') }}</p>
                            </td>
                            <td class="align-middle text-center">
