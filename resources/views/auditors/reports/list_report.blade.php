                            ...
                            <table class="table align-items-center mb-0 text-xs">
                                ...
                                <tbody>
                                    @forelse($absensis as $abs)
                                        <tr style="cursor: pointer;" onclick="window.location='{{ route('list_report_daily_auditor', ['Id_Report' => $report->Id_Report, 'date' => \Carbon\Carbon::parse($abs->tanggal)->format('Y-m-d')]) }}'">
