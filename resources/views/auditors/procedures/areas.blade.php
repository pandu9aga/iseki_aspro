...
<div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('procedure_auditor.area.index', ['Name_Tractor' => $tractor]) }}">{{ $tractor }}</a></li>
        </ol>
    </nav>
    <br>
                ...
                <table id="example" class="table align-items-center mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <p class="text-xs">
                                    <a href="{{ route('procedure_auditor.procedure.index', ['Name_Tractor' => $a->Name_Tractor, 'Name_Area' => $a->Name_Area]) }}" class="text-primary font-weight-bold">
                                        {{ $a->Name_Area }}
                                    </a>
                                </p>
                            </td>
