...
class ProcedureAuditorController extends Controller
{
    public function index()
    {
        ...
        return view('auditors.procedures.index', compact('page', 'tractors', 'tractorProcedureCounts'));
    }
    ...
    public function index_area($Name_Tractor)
    {
        ...
        return view('auditors.procedures.areas', compact('page', 'tractor', 'photoTractor', 'areas'));
    }
    ...
    public function index_procedure($Name_Tractor, $Name_Area)
    {
        ...
        return view('auditors.procedures.procedures', compact('page', 'tractor', 'photoTractor', 'area', 'procedures'));
    }
}
